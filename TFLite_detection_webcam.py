...
while True:
    ...
    frame_resized = cv2.resize(imgS, (width, height))
    ...
    for i in range(len(scores)):
        if ((scores[i] > min_conf_threshold) and (scores[i] <= 1.0)):
            ...
            label =(object_name) #int(scores[i]*100)) # Example: 'person: 72%'
            ...
            text1 = label + " is detected."
            print(text1)
            language = "en"
            object = gTTS(text=text1, lang=language, slow=False)
            object.save("output1.mp3")
        
                    
                
                #playsound('output.mp3')
                #os.system('/home/pi/tflite1/output1.mp3')
            os.system("omxplayer output1.mp3")
